...
fast: $(DIST_DIR)/lib/libc.so $(DIST_DIR)/c11-kompiled/c11-kompiled/compiled.bin
...
$(DIST_DIR)/c11-kompiled/c11-kompiled/compiled.bin: $(DIST_DIR)/kcc semantics-fast
	@cp -p -r $(SEMANTICS_DIR)/c11-kompiled $(DIST_DIR)

$(DIST_DIR)/c11-translation-kompiled/c11-translation-kompiled/compiled.bin: $(DIST_DIR)/kcc semantics-fast
	@cp -p -r $(SEMANTICS_DIR)/c11-translation-kompiled $(DIST_DIR)

$(DIST_DIR)/c11-nd-kompiled/c11-nd-kompiled/compiled.bin: semantics
	@cp -r $(SEMANTICS_DIR)/c11-nd-kompiled $(DIST_DIR)

$(DIST_DIR)/c11-nd-thread-kompiled/c11-nd-thread-kompiled/compiled.bin: semantics
	@cp -r $(SEMANTICS_DIR)/c11-nd-thread-kompiled $(DIST_DIR)

$(DIST_DIR)/lib/libc.so: $(DIST_DIR)/c11-translation-kompiled/c11-translation-kompiled/compiled.bin $(wildcard $(LIBC_DIR)/src/*) $(SCRIPTS_DIR)/kcc
...
$(DIST_DIR): test-build $(DIST_DIR)/c11-nd-kompiled/c11-nd-kompiled/compiled.bin $(DIST_DIR)/c11-nd-thread-kompiled/c11-nd-thread-kompiled/compiled.bin
